...
RenderingSystem::RenderingSystem(std::string programName, int screenWidth,
								 int screenHeight) {
...
SDL_Window *RenderingSystem::getWindow() { return window; }
SDL_GLContext *RenderingSystem::getRenderingContext() { return &renderContext; }
...
void RenderingSystem::initSDL() {
	...
	// Window creation
	window = SDL_CreateWindow(programName.c_str(), SDL_WINDOWPOS_CENTERED,
...
GLuint RenderingSystem::loadShaders(const char *vertexShader,
